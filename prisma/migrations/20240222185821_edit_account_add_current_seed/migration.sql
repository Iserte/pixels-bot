...
INSERT INTO "new_Account" ("carnivalUpdate", "coin", "energy", "energyUpdate", "id", "landOneState", "landOneUpdate", "landThreeState", "landThreeUpdate", "landTwoState", "landTwoUpdate", "mailUpdate", "name", "pixel", "seeds", "vipUpdate") SELECT "carnivalUpdate", "coin", "energy", "energyUpdate", "id", "landOneState", "landOneUpdate", "landThreeState", "landThreeUpdate", "landTwoState", "landTwoUpdate", "mailUpdate", "name", "pixel", "seeds", "vipUpdate" FROM "Account";
DROP TABLE "Account";
