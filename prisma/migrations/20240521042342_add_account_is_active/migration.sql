...
INSERT INTO "new_Account" ("carnivalUpdate", "cityTreeUpdate", "coin", "currentSeed", "energy", "energyUpdate", "id", "landOneState", "landOneUpdate", "landThreeState", "landThreeUpdate", "landTwoState", "landTwoUpdate", "levels", "mailUpdate", "name", "nuCyberFirstRun", "nuCyberUpdate", "pixel", "quests", "seeds", "vipExpiration", "vipUpdate", "wallet") SELECT "carnivalUpdate", "cityTreeUpdate", "coin", "currentSeed", "energy", "energyUpdate", "id", "landOneState", "landOneUpdate", "landThreeState", "landThreeUpdate", "landTwoState", "landTwoUpdate", "levels", "mailUpdate", "name", "nuCyberFirstRun", "nuCyberUpdate", "pixel", "quests", "seeds", "vipExpiration", "vipUpdate", "wallet" FROM "Account";
DROP TABLE "Account";
