...
INSERT INTO "new_Account" ("carnivalUpdate", "coin", "currentSeed", "energy", "energyUpdate", "id", "landOneState", "landOneUpdate", "landThreeState", "landThreeUpdate", "landTwoState", "landTwoUpdate", "levels", "mailUpdate", "name", "nuCyberFirstRun", "nuCyberUpdate", "pixel", "seeds", "vipExpiration", "vipUpdate", "wallet") SELECT "carnivalUpdate", "coin", "currentSeed", "energy", "energyUpdate", "id", "landOneState", "landOneUpdate", "landThreeState", "landThreeUpdate", "landTwoState", "landTwoUpdate", "levels", "mailUpdate", "name", "nuCyberFirstRun", "nuCyberUpdate", "pixel", "seeds", "vipExpiration", "vipUpdate", "wallet" FROM "Account";
DROP TABLE "Account";
