...
function DoCraft(gamePage, account, craftType, craftName) {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield gamePage.waitForTimeout(5000);
        yield gamePage.locator("button[class*=Store_buyButton_]").nth(1).click({ timeout: 5000 });
