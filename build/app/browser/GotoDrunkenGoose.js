...
exports.GotoDrunkenGoose = void 0;
const WaitForLoad_1 = require("../../utils/WaitForLoad");
const GotoTerravilla_1 = require("../../utils/game/GotoTerravilla");
const GotoDrunkenGoose = (gamePage) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, GotoTerravilla_1.GotoTerravilla)(gamePage);
    yield gamePage.goto("https://play.pixels.xyz/pixels/DrunkenGooseInterior");
...
exports.GotoDrunkenGoose = GotoDrunkenGoose;
