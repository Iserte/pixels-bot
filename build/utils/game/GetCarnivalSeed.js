...
exports.GetCarnivalSeed = void 0;
const pngjs_1 = require("pngjs");
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const pixelmatch_1 = __importDefault(require("pixelmatch"));
const WaitForLoad_1 = require("../WaitForLoad");
const GetCarnivalSeed = (gamePage, tempPage, carnivalSeed) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    yield (0, WaitForLoad_1.WaitForLoad)(gamePage);
    const itemList = gamePage.locator('div[class*=Hud_itemList_]');
    let seed;
    if (carnivalSeed === "Orange Grumpkin Seeds") {
        seed = itemList.locator('div[class*=Hud_item_]').nth(4);
    }
    if (carnivalSeed === "Cotton Candy Seeds") {
        seed = itemList.locator('div[class*=Hud_item_]').nth(5);
    }
...
exports.GetCarnivalSeed = GetCarnivalSeed;
